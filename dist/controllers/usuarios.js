...
var _index = require("../login/index.js");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          validate && (validate = email && typeof email === 'string');
          validate && (validate = pass && typeof pass === 'string' && pass.length > 2);
          if (validate) {
            _context.next = 6;
            break;
          }
        ...
        case 8:
          ...
          _context.next = 13;
          return (0, _hash.compararHash)(pass, onename.pass);
        case 13:
          login = _context.sent;
        case 14:
...
var getUsuario = /*#__PURE__*/function () {
  ...
  return function getUsuario(_x3, _x4) {
...
var addUsuario = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, name, email, pass, verificado, passHasheada, usuario;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _req$body2 = req.body, name = _req$body2.name, email = _req$body2.email, pass = _req$body2.pass;
          verificado = name && pass && email;
          if (verificado) {
            _context4.next = 5;
            break;
          }
          return _context4.abrupt("return", res.status(400).json({
            info: 'Debe ingresar name, email y pass'
          }));
        case 5:
          _context4.next = 7;
          return (0, _hash.generarHash)('' + pass);
        case 7:
          passHasheada = _context4.sent;
          _context4.next = 10;
          return User.create({
            name: name,
            email: email,
  ...
  return function addUsuario(_x7, _x8) {
...
var updateUsuario = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 7:
          ...
          _context6.next = 11;
          return (0, _hash.generarHash)(req.body.pass);
        case 11:
          usuario.pass = _context6.sent;
          usuario.save();
          res.json({
  ...
  return function updateUsuario(_x11, _x12) {
